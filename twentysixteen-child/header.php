		...
		<header id="masthead" class="site-header" role="banner">
			<div class="site-header-main">
				<div class="site-branding">
					...
					<!-- Comment out the site title and description
				...
				<?php endif; ?>
			</div><!-- .site-header-main --> <!-- Full width slide plugin's short code. -->
			<?php 
			if (function_exists('wd_slider')) { // if the slider plugin is deactivated, this function won't exist
				wd_slider(1);
			}
			?>
